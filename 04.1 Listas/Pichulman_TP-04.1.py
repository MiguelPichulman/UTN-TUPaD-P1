...
lista=[123, "casa", True, "321", "A"]
print(lista[3])#utilizando indice conocido
print(lista[-2])#utilizando indexing negativo
...
print(numeros)
#EXPLICACION: el codigo crea una lista con 5 numeros enteros, elimia al mayor de elloy luego imprime en pantalla la lista
